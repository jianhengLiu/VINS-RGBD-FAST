...
getMeasurements()
{
    ...
    while (true)
    {
        ...
        {
            cout<<"imu_buf.front()->header.stamp.toSec()"<<endl<<imu_buf.front()->header.stamp.toSec()<<endl;
            cout<<"feature_buf.front()->header.stamp.toSec()"<<endl<<feature_buf.front()->header.stamp.toSec()<<endl;
...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_image = n.subscribe("/feature_tracker/feature", 1000, feature_callback);
    ros::Subscriber sub_restart = n.subscribe("/feature_tracker/restart", 1000, restart_callback);
